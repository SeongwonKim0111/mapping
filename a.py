...
from MW_wall_following import ManhattanWallFollower
...
if __name__ == '__main__':
    ...
    wall_following = ManhattanWallFollower()
            ...
            with Multiranger(scf) as multiranger:
                with SyncLogger(scf, lg_stab) as logger:
                    ...
                    while keep_flying:
                        ...
                        velocity_y = 0.0
                        yaw_rate = 0.0
                        state_wf = ManhattanWallFollower.State.HOVER
                        ...
                        velocity_x, velocity_y, yaw_rate, state_wf = wall_following.update(
                            front_range, left_range, actual_yaw_rad, time.time())
